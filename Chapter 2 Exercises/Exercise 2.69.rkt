...
(define s-msg '(A D A B B C A))

(define l-pairs '((A 4) (B 2) (C 1) (D 1)))

(define h-pairs (make-leaf-set l-pairs))

(define t (generate-huffman-tree l-pairs))

; (decode (encode s-msg s-tree) s-tree)
; (decode (encode s-msg t) t)
